...
// <td class="primary">${formattedDate || user?.timestamp.toDate()} </td>
console.log(typeof user?.timestamp);
    const template = `
    <tr>
    ...
    <td class="action">
      ...
      <a href="${user.role === 'admin' ? 'javascript:alert(\'Không thể xóa\')' : `/Dashboard/update-user.html?id=${user.id}`}" style="width: 25px; height: 25px; margin: 0;">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
